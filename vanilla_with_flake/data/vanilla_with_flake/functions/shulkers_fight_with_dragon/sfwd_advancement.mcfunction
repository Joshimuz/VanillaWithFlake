...
execute in minecraft:the_end at @e[type=minecraft:armor_stand, tag=sfwd] as @e[type=minecraft:end_crystal, distance=25..250, limit= 5, sort=random] at @s run summon minecraft:shulker ~ ~-2 ~ {Color:15, PersistenceRequired:1}
